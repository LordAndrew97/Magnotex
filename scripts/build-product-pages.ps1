...
$catalogDataPath = Join-Path $projectRoot 'assets\productos-magnotex.js'
...
[System.IO.File]::WriteAllText($catalogDataPath,"window.MAGNOTEX_PRODUCTS=$catalogJson;`n",$utf8NoBom)
